...
const diffCards: CompareCard[] = [
  {
    ...
    body: "Adaptive is a strong product, but its AI features are added on top of an architecture from before LLM tool-use was viable. NashOS was designed around an agent that can read AND write the cube safely.",
  },
  {
    headline: "Forecasting depth that doesn't require an ML team",
    body: "15 algorithms shipped, with R²/RMSE/MAPE comparisons baked in. Adaptive forecasts are fine for trend extrapolation — for AI-driven what-if, NashOS goes further.",
  },
  {
    headline: "No Workday lock-in required",
    body: "If you're not on Workday HCM, Adaptive's biggest integration advantage doesn't apply. NashOS stays integration-agnostic — REST/SFTP/Excel/CSV today, with NetSuite + QuickBooks on the roadmap.",
  },
  {
    headline: "Pricing that lets a 30-person company actually buy it",
    body: "Adaptive's mid-market pricing starts in six figures. NashOS is $99–$499/mo for the same core capabilities. The CFO who'd never get budget for Adaptive can buy this on a credit card.",
  },
];
...
export default function VsAdaptivePage() {
  return (
    <ComparisonPage
      ...
      kicker="NASHOS VS ADAPTIVE"
      headline="AI-native planning, without the Workday tax."
      subhead="Workday Adaptive Planning is a great fit if you're already a Workday HCM customer. If you're not, you're paying an enterprise tax for a tool that wasn't designed around modern AI. NashOS is the alternative: AI-first, mid-market price, ready in hours."
      rows={rows}
      diffCards={diffCards}
      whoIsItFor={{
